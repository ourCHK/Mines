...
public class MineViewTest extends SurfaceView implements SurfaceHolder.Callback,Runnable{
    ...
    public MineViewTest(Context context) {
        super(context);
        init1();
    }

    public MineViewTest(Context context, AttributeSet attrs) {
        super(context, attrs);
        init1();
    }
