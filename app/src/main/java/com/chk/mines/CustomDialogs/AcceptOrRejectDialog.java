...
public class AcceptOrRejectDialog extends Dialog implements OnTimeEnd {

    private final static String TAG = AcceptOrRejectDialog.class.getSimpleName();
    ...
    public AcceptOrRejectDialog(@NonNull Context context) {
        super(context);
     ...
     * @param time  //设置的对话框自动关闭拒绝的时间
     */
    public AcceptOrRejectDialog(@NonNull Context context, int themeResId,String showText,int time) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_layout_accept_or_reject);
