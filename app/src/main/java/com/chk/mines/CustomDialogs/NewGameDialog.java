...
public class NewGameDialog extends Dialog implements OnTimeEnd {

    private final static String TAG = NewGameDialog.class.getSimpleName();
    ...
    public NewGameDialog(@NonNull Context context, int themeResId) {
